  ...
  <main class="page-content" aria-label="Content">
      <header class="header">
        ...
        <h1 class="header-title" itemprop="headline"></h1>
          ...
          <div class="page-content">/* global hexo */
'use strict';
...
if (config.autodiscovery === true) {
  hexo.extend.filter.register('after_render:html', require('./lib/autodiscovery'));
    ...
    <a class="post-nav-item post-nav-prev" href="/2023/03/13/bug%E8%BF%99%E4%B9%88%E5%A4%9A%E6%83%B3%E6%AD%BB/">
      <div class="nav-arrow">&lt;&nbsp;NEWER</div>
      <span class="post-title">bug这么多想死</span>
    </a>
    
    
    <a class="post-nav-item post-nav-next" href="/2023/03/13/%E6%97%A5%E5%B8%B8/">
      <div class="nav-arrow">OLDER&nbsp;&gt;</div>
      <span class="post-title">日常</span>
    </a>
